...
DEST_PARENT_ID = os.getenv("WEEKLY_DEST_FOLDER")  # set in workflow

# The seven individual spreadsheet IDs to duplicate:
FILE_SOURCES = [
...
def find_or_create_folder(drive, parent_id: str, name: str) -> str:
    """Look for (or create) a folder named `name` under `parent_id`."""
    q = (
